...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getsubscribe = __webpack_require__(346);
	...
	*/
	...
	//Buffer 
	var obs1$ = _Rx2.default.Observable.interval(1000);
	var obs2$ = _Rx2.default.Observable.fromEvent(document, 'click');

	var myBuffer = obs1$.buffer(obs2$);
	var subscribe = myBuffer.subscribe((0, _getsubscribe.getSubscribe)('Buffer From Event'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nextTick = __webpack_require__(287).nextTick;
