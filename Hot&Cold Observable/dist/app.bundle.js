...
/***/ function(module, exports, __webpack_require__) {
	...
	var refCount$ = _Rx2.default.Observable.interval(1000).publish().refCount();

	setTimeout(function () {
		refCount$.subscribe((0, _getsubscribe.getSubscribe)('One'));
		setTimeout(function () {
			refCount$.subscribe((0, _getsubscribe.getSubscribe)('Two'));
		}, 4000);
	}, 2000);
